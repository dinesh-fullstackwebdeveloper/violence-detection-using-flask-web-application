...
def send_email(subject, body, attachment=None):
    try:
        ...
        username = "jddotnet123@gmail.com"
        password = "gypehfixynwzjoxk"
        ...
        msg = MIMEMultipart()
        msg['From'] = username
        msg['To'] = 'balakrishnandinesh981@gmail.com'
...
def generate_frames(video_path):
    model = load_model('Own_dataset_mobi_Lstm3.h5', compile=False)
    ...
    while video_reader.isOpened():
        ...
        if predicted_class_name == "Violence":
            cv2.putText(frame, text, (10, 100), cv2.FONT_HERSHEY_SIMPLEX, text_size / 100, (0, 0, 0), 5)
            ...
            cv2.putText(frame, text, (10, 100), cv2.FONT_HERSHEY_SIMPLEX, text_size / 100, (0, 255, 0), 5)
